# Critique Agent — AutoGen implementation

Two-agent critique / refine / consensus loop built with [`autogen-agentchat`](https://microsoft.github.io/autogen/),
talking to a local Ollama model (`qwen3:8b`) through its OpenAI-compatible API.
